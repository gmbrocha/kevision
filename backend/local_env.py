...
ALLOWED_LOCAL_ENV_KEYS = {
    ...
    "SCOPELEDGER_CLOUDHAMMER_DEBUG_ARTIFACTS",
    "SCOPELEDGER_CLOUDHAMMER_MODEL",
    "SCOPELEDGER_CLOUDHAMMER_TIMEOUT_SECONDS",
    "SCOPELEDGER_MANIFEST_ASSISTED_SCAN",
    "SCOPELEDGER_MAX_UPLOAD_BYTES",
    "SCOPELEDGER_POPULATE_IMPORT_CHECKS",
    "SCOPELEDGER_PREREVIEW_BATCH_SIZE",
    "SCOPELEDGER_PREREVIEW_CONCURRENCY",
    "SCOPELEDGER_PREREVIEW_ENABLED",
    "SCOPELEDGER_PREREVIEW_LEGACY_CACHE_LOOKUP",
