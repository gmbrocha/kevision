...
class Exporter:
    ...
    def export(self, force_attention: bool = False) -> dict[str, str]:
        ...
        outputs = {
            ...
            "revision_changelog_xlsx": str(self._write_revision_changelog_xlsx()),
    ...
    def _write_revision_changelog_xlsx(self) -> Path:
        path = self.store.output_dir / "revision_changelog.xlsx"
        return write_revision_changelog(self.store, path)
