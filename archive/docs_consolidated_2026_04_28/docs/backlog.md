...
Update from Kevin 2026-04-24:

- RFI information and relevant notes need to be transferred when updating the current drawing set.
- RFIs may address critical dimensions/layout items even when no formal revision set is issued.
- Comments from a superseded page need to carry forward to the latest revision drawing so RFI comments and ESA notes are not lost.

V1 implication:

- Full RFI automation remains backlog.
- The conformed/current-set workflow should still flag superseded sheets where prior comments/RFI/ESA notes may need carry-forward review.
