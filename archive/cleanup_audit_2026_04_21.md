...
The obvious reference artifacts were moved out of repo root into
`docs/anchors/`. That leaves the root less noisy without touching runtime
code.
...
| `docs/anchors/mod_5_changelog.xlsx` | Kevin's source file (canonical reference) | Moved out of repo root |
| `docs/anchors/revision.png` | Image anchor for Kevin's email | Moved out of repo root |
| `docs/anchors/revision_cloud_example_2.png` | Image anchor referenced by `KEVIN_QUESTIONS.md` row 14 | Moved out of repo root |
| `docs/anchors/kevin_email.txt` | Provenance: Kevin's email content | Moved out of repo root |
...
References in `KEVIN_QUESTIONS.md` and the small changelog-inspection
utilities were updated at the same time.
...
source material (`docs/anchors/mod_5_changelog.xlsx`, `experiments/mod_5_changelog_dump/`)
