...
- Exploratory app-run observations in
  `docs/history/FINDINGS_FIRST_REAL_RUN.md` are triage notes only and do not
  become labels or training data without a durable review workflow.
